...
class Zend_Db_Adapter_Firebird extends Zend_Db_Adapter_Abstract{ 
    ...
    { 
        ...
        if ($queryResult = ibase_query($this->getConnection(), $sql)) { 
            ...
            throw new Zend_Db_Adapter_Firebird_Exception($this->getConnection()->error); 
        } 
        return $result; 
    } 
    ...
    { 
        $this->_connect(); 
        ibase_trans(0, $this->_connection); 
    } 
    ...
    { 
        if (!ibase_commit($this->_connection)) { 
            /**
             * @see Zend_Db_Adapter_Firebird_Exception
             */ 
            require_once 'Zend/Db/Adapter/Firebird/Exception.php'; 
    ...
    { 
        if (!ibase_rollback($this->_connection)) { 
            /**
             * @see Zend_Db_Adapter_Firebird_Exception
             */ 
            require_once 'Zend/Db/Adapter/Firebird/Exception.php'; 
